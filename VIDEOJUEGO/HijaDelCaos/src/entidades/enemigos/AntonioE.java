...
public class AntonioE extends Jefe{
    ...
    public AntonioE(float x, float y) throws SlickException {
        super("resources/Personajes/Antonio/Antonio.png", "resources/Pantalla de Batalla/Antonio_Enemigo/Antonio_Enemigo.png", 64, 64, 4, 4, new int[]{3,2,2,2}, "Antonio", 64, 64);
        combatir();
