    ...
    public void genEnemigos() throws SlickException{
        ...
        switch(nombre){
                ...
                case "DungeonTorrePlanta3":
                    ...
                    PaulaE pa = new PaulaE(217, 268);
                    pa.setVelocidad(new Vector(new Punto(200, 200)));
                    pa.setRango(1000);
                    pa.setLVL(10);
                    pa.calcEst();
                    AntonioE an = new AntonioE(259, 247);
                    an.setVelocidad(new Vector(new Punto(200, 200)));
                    an.setRango(1000);
                    an.setLVL(10);
                    an.calcEst();
                    aux.add(pa);
                    aux.add(an);
                    ce = new ConjuntoEnemigos(aux, new Punto(217, 298));
                    this.enemigos.add(ce);
                ...
                case "Dungeon_Final":
                    ...
                    Clerigo cl2 = new Clerigo(-1000, -1000);
